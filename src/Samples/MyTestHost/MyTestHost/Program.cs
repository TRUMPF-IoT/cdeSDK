...
namespace MyTestHost
{
    class Program
    {
        ...
        private static void SinkTimer(long obj)
        {
            //if (obj % 5 == 0) // Send a message every 5 seconds
            //    TheCommCore.PublishCentral(new TSM("MyTestEngine2", $"HELLO:{counter++}", "MyTestPayload"), false);
        }
